...
const Resume = () => {
  ...
  return (
    ...
    <div className="bg-white">
      ...
      <Navbar isMobileMenuOpen={isMobileMenuOpen} toggleMobileMen={toggleMobileMenu}/>
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center" id='AboutMe'>
            ...
            <h1 className="text-4xl font-bold tracking-tight text-teal-500 sm:text-6xl animate-pulse">{staticData.name}</h1>
            <p className="text-gray-600">{staticData.role}</p>
            <p className="mt-6 text-lg leading-8 text-gray-600">{staticData.aboutMe}</p>
